c# NPlayer Master Implementation Guide
...
## 1.1 Bản chất dự án
NPlayer là nền tảng học tập và hướng nghiệp cho học sinh THPT, có 3 vai trò chính:
- Student
- Teacher
- Admin
...
# Phase 0 — Chuẩn hóa project foundation

## Mục tiêu
Dựng nền để toàn bộ các phase sau phát triển ổn định.

## Phải có
- Chuẩn hóa tên project về NPlayer
- Chuẩn hóa package root
...
## Kafka event
- LessonCompletedEvent -> nplayer.lesson.completed
...
## Kafka event
- QuizSubmittedEvent -> nplayer.quiz.submitted
...
## Kafka event
- ComboEnrolledEvent -> nplayer.combo.enrolled
...
## Kafka event
- ContentReviewedEvent -> nplayer.content.reviewed
...
## Kafka event
- RecommendationGeneratedEvent -> nplayer.recommendation.generated
...
## Prompt tổng quát
```text
Bạn là senior backend engineer. Hãy triển khai project NPlayer theo đúng roadmap trong file này.
...
```text
Hãy triển khai Phase X của NPlayer theo file master implementation guide.
...
- Tên project/package/db không thống nhất
...
Hãy dùng file này như **bản đồ triển khai** và **bản đồ học lại**.
